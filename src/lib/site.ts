// Site-wide constants — CINEMA LIVE brand
import { listingRoute } from './routes';

export const SITE = {
  name: 'سينما لايف',
  nameEn: 'CinemaLive',
  nameLatin: 'CINEMA LIVE',
  tagline: 'مشاهدة أفلام ومسلسلات وأنمي مترجمة اون لاين بجودة عالية',
  description:
    'سينما لايف CinemaLive موقع عربي لمشاهدة احدث الافلام والمسلسلات والانمي مترجم اون لاين بجودة عالية HD و4K مجاناً بدون اعلانات مزعجة، مع تحديث يومي وروابط مشاهدة مباشرة سريعة.',
  url: 'https://cima-liveapp.site',
  locale: 'ar-SA',
  themeColor: '#06b6d4',
